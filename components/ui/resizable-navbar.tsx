...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-xl bg-transparent px-4 py-4 lg:flex",
        visible && "bg-white/80",
        className,
      )}
    >
...
export const NavbarLogo = () => {
  return (
    <a
      href="#"
      className="relative z-20 mr-4 flex flex-col items-start space-y-0.5 px-2 py-1 text-sm font-normal text-black"
    >
      <div className="flex items-center space-x-2">
        ...
        <div className="flex flex-col leading-tight">
          ...
          <span className="font-medium text-black lowercase">fang.com.au</span>
        </div>
      </div>
    </a>
  );
