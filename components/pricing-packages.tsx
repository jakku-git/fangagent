            ...
            >
              ...
              {index === 1 ? (
                ...
                <div className="flex items-center justify-center gap-2 sm:gap-4 mb-5 sm:mb-7">
                  ...
                  >
                    <img src="/hero.png" alt="Fang" className="w-full h-full object-cover rounded-full group-hover:scale-110 transition-transform duration-300" style={{ filter: 'brightness(0) invert(1)' }} />
                  </motion.div>
                  <motion.div
