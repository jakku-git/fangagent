    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h3 className="text-3xl font-extrabold mb-8 text-center tracking-tight font-sans">{content[language].cta}</h3>
            ...
            <div className="space-y-4">
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
              >
                <Button className="w-full bg-gradient-to-r from-white to-white hover:from-white hover:to-white text-blue-900 font-semibold py-4 text-lg rounded-full">
          ...
          >
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/20 cursor-pointer group"
            >
              <div className="flex items-center mb-4">
                <div className="bg-gradient-to-r from-green-500 to-green-600 p-4 rounded-full mr-4 group-hover:scale-110 transition-transform duration-300">
                  <Upload className="h-8 w-8 text-white" />
                </div>
                <h4 className="text-2xl font-extrabold tracking-tight font-sans">{content[language].form.upload}</h4>
              </div>
            ...
            >
              <div className="flex items-center mb-4">
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-4 rounded-full mr-4 group-hover:scale-110 transition-transform duration-300">
                  <Calendar className="h-8 w-8 text-white" />
                </div>
                <h4 className="text-xl font-bold">{content[language].form.schedule}</h4>
              </div>
              <p className="text-blue-100 leading-relaxed">
                {language === "en"
