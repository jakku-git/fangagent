    ...
    <section ref={ref} className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-2xl text-gray-600 max-w-3xl mx-auto font-medium leading-relaxed drop-shadow-lg font-sans">{content[language].subtitle}</p>
        </motion.div>
                ...
                <div className="flex-1 max-w-lg">
                  ...
                  >
                    <div className="flex items-center mb-4">
                      {index === 2 ? (
                        <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-3 rounded-full mr-4">
                          <img
                            src="/hero.png"
                            alt="Step 3"
