    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 32px;">
          <h2 style="font-size: 20px; font-weight: 600; margin-bottom: 24px;">New Media Kit Request</h2>
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
              ...
              <td style="padding: 12px 0; border-bottom: 1px solid #e5e7eb; font-size: 14px;">${phone}</td>
            </tr>
            <tr>
              <td style="padding: 12px 0; color: #6b7280; font-size: 14px;">Email</td>
              <td style="padding: 12px 0; font-size: 14px;"><a href="mailto:${email}">${email}</a></td>
            </tr>
          </table>
        </div>
      `,
